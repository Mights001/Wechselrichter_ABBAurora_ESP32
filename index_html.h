...
<!DOCTYPE HTML><html><head>
  <title>ABBAurora beim Weis</title>
...
#wertetabel tr:hover {background-color: #ddd;}
  ...
  <tr>
    <td style="text-align: left;" id="type_obj0"></td>
    <td id="value_obj0"></td>
    <td id="unit_obj0"></td>
  </tr>
  <tr>
    <td style="text-align: left;"  id="type_obj1"></td>
    <td id="value_obj1"></td>
    <td id="unit_obj1"></td>
  </tr>
  <tr>
    <td style="text-align: left;"  id="type_obj2"></td>
    <td id="value_obj2"></td>
    <td id="unit_obj2"></td>
  </tr>
  <tr>
    <td style="text-align: left;"  id="type_obj3"></td>
    <td id="value_obj3"></td>
    <td id="unit_obj3"></td>
  </tr>
  <tr>
    <td style="text-align: left;"  id="type_obj4"></td>
    <td id="value_obj4"></td>
    <td id="unit_obj4"></td>
  </tr>
  
  <tr>
    <td style="text-align: left;"  id="type_obj5"></td>
    <td id="value_obj5"></td>
    <td id="unit_obj5"></td>
  </tr>
  <tr>
    <td style="text-align: left;"  id="type_obj6"></td>
    <td id="value_obj6"></td>
    <td id="unit_obj6"></td>
  </tr>
